...
testeprot = MyClass(testeprotg,0,10.0,10,0)
...
xBulk=0
kcalBulkPROTLproth1 = kcal-(protlBulkRestante*4)
kcalBulkprotlPROTH2 = kcal-(prothBulkRestante*4)
kcalBulkPROTLPROTH3 = kcal-((protlBulkRestante*4)+(prothBulkRestante*4))
...
kcalCutPROTLproth1 = kcal -(protlCutRestante*4)
kcalCutprotlPROTH2 = kcal -(prothCutRestante*4)
kcalCutPROTLPROTH3 = kcal -((protlCutRestante*4)+(prothCutRestante*4))
xCut=0
while xBulk<6:
    ...
    elif list2Bulking[0]<list1Bulking[0] and list2Bulking[1]>list1Bulking[1] and xBulk==5 and kcalBulkPROTLproth1-gastoBulk>=0:
    ...
    elif list2Bulking[0]<list1Bulking[0] and list2Bulking[1]<list1Bulking[1] and xBulk==5 and kcalBulkPROTLPROTH3-gastoBulk>=0:
